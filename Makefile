...
test: ## run tests (and coverage if configured in setup.cfg) with the default Python
	@echo -----------------------------------------------------------------
	@echo RUNNING TESTS...
	poetry run pytest --cov=llm_zoomcamp_damon
...
install: clean ## install the package to the active Python's site-packages via pip
	@echo -----------------------------------------------------------------
	@echo INSTALLING llm_zoomcamp_damon...
	poetry install
	@echo INSTALLED llm_zoomcamp_damon
	@echo - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	@echo llm_zoomcamp_damon info:
	@echo - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	pip show llm_zoomcamp_damon
	@echo -----------------------------------------------------------------
